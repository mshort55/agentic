...
Reads design specs, selects relevant agents, launches them in parallel, synthesizes their recommendations, resolves conflicts, and generates analysis reports saved to `output/analysis-reports/`.
